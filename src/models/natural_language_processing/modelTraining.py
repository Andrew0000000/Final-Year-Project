...
from data_processing.dataProcessing import download_nltk_resources, preprocess_description_list, get_set_of_duties, get_total_pgta_hours
import numpy as np
...
print(get_set_of_duties(df_jobDescriptionData['Duties']))