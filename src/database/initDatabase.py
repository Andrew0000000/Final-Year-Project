...
from models import JobDescription, RequestedVsRecruited, CapVsActualStudents, ModuleAssessment, CombinedData, AveragePGTAHours
from data_processing.dataframeCleaning import df_jobDescriptionDataCleaned, df_requestedVsRecruitedCleaned, df_capVsActualStudentsCleaned, df_moduleAssessmentDataCleaned, df_combined_data, df_averagePGTAHours
...
def init_db():
    ...
    load_csv_to_database(df_combined_data, CombinedData, session)
